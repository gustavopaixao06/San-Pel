    ...
    <>
      <section className="primeira-secao">
        ...
        <div className="info-home">
          <h1>
            Excelência em qualidade e pont{" "}
            <img src={imgSoldador} alt="" id="imgSoldador" />
          </h1>
          <div className="linha-home"></div>
          <p>
            Na <span style={{ color: "#FDC204" }}>SAN PEL</span>, somos
            especialistas em caldeiraria e solda, oferecendo soluções de alta
            qualidade e precisão para atender às necessidades dos nossos
            clientes.
          </p>
        </div>
      </section>
      <section className="segunda-secao">
        <div className="sobreHome">
          ...
          <div className="descricao">
            <div className="soldador">
              <img src="/img/img1.jpg" alt="" />
            </div>

            <div className="paragrafo">
              <p>
                Bem-vindo à nossa empresa de calderaria e solda, onde tradição e
                inovação se encontram para oferecer soluções robustas e de alta
                qualidade. Com anos de experiência no mercado, nos
                especializamos em fornecer serviços personalizados, atendendo às
                necessidades específicas de cada cliente, desde pequenos
                projetos até grandes empreendimentos industriais.
              </p>

              <div className="botao">
                <Link to="/sobre" onClick={scrollToTop}>
      ...
      <section className="terceira-secao">
        <div className="servicos">
          ...
          <p>
            Descubra tudo que a{" "}
            <span style={{ color: "#FDC204" }}>San Pel</span> pode te oferecer
          </p>
        </div>
        ...
        <div className="cardsServicos">
          <div className="part1">
            <Link to="/nossosServicos" onClick={scrollToTop}>
              <div className="card1">
                <img
                  className="imgServico1"
                  src="/img/calderaria.jpg"
                  alt=""
                  style={imageStyle}
                />
            ...
            <Link to="/nossosServicos" onClick={scrollToTop}>
              <div className="card1">
                <img
                  className="imgServico"
                  src="/img/tubulacao.svg"
                  alt=""
                  style={imageStyle}
                />
            ...
            <Link to="/nossosServicos" onClick={scrollToTop}>
              <div className="card1">
                <img
                  className="imgServico"
                  src="/img/estrutura.svg"
                  alt=""
                  style={imageStyle}
                />
                <p>Estruturas Metálicas em Geral</p>
                <div className="saibaMais">
                  <span>Saiba mais</span>
                  <img src="/img/seta.svg" alt="" />
                </div>
      ...
      <div className="fixed-bottom">
        <a
          id="botaoFixo"
          href="https://web.whatsapp.com/send?phone=5515981061909"
          target="_blank"
        ...
        <a
          id="botaoFixo"
          href="https://www.instagram.com/sanpel.caldeiraria/"
          target="blank"
        >
